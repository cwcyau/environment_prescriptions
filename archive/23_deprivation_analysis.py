import xarray as xr
from funcs import status, prepare_ds, run_deprivation_mixed_models, compare_deprivation_analyses
...
standardise_items = False  # whether to standardise items variable (per practice)
...
if __name__ == "__main__":
    for codes in prescription_codes:
        ...
        status("Running deprivation mixed models...")
