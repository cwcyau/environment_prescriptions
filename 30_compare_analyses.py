...
import arviz as az
import numpy as np
from funcs import compare_mixed_models, compare_bayesian_models, generate_bayesian_diagnostics, status, plot_months_bayes, combined_lagged_predictor_plot
...
combined_lagged_predictor_plot(root)